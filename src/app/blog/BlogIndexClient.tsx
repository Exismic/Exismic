          ...
          {posts.map((post, index) => (
            ...
            >
              <motion.div
                ...
                className="relative overflow-hidden rounded-[2.5rem] border border-white/[0.05] bg-[#050508]/60 p-8 sm:p-12 shadow-[0_20px_40px_rgba(0,0,0,0.4)] backdrop-blur-md transition-all duration-500 group-hover:border-cyan-500/30 group-hover:bg-[#0a0a0f]/80 group-hover:shadow-[0_30px_60px_rgba(34,211,238,0.15)]"
              >
