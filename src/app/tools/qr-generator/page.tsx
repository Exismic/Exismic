...
export default function QrGeneratorPage() {
  return (
    <div className="min-h-screen bg-[#050505] px-4 pb-6 pt-24 font-sans text-white selection:bg-purple-500/30 sm:px-6 md:px-12 md:pb-12 md:pt-28" suppressHydrationWarning>
        ...
        <header className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="text-center md:text-left">
            ...
            <p className="text-gray-400 text-lg md:text-xl max-w-2xl font-medium">
              Transform standard black-and-white QR codes into custom, stunning, scannable generative art for free.
            </p>
          </div>
        </header>
      ...
      <div className="fixed top-0 right-0 -z-10 w-[700px] h-[700px] bg-purple-600/[0.03] blur-[150px] rounded-full pointer-events-none" />
      <div className="fixed bottom-0 left-0 -z-10 w-[600px] h-[600px] bg-indigo-600/[0.025] blur-[150px] rounded-full pointer-events-none animate-pulse" />
    </div>
  );
}
