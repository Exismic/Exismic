        ...
        <header className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start gap-3 mb-4">
              ...
              <h1 className="text-4xl md:text-5xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white via-white to-blue-400">
                AI Landing Page
              </h1>
            </div>
            <p className="text-gray-400 text-lg md:text-xl max-w-2xl font-medium">
              Draft fully responsive, beautifully styled HTML landing page mockups from text prompts in seconds.
            </p>
          </div>
        </header>
