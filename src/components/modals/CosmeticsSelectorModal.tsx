      ...
      <AnimatePresence>
        ...
        >
          <motion.div
            ...
            className="relative w-full max-w-5xl max-h-[92dvh] h-[88dvh] flex flex-col bg-[#070812] border-2 border-amber-400/40 rounded-2xl sm:rounded-[2.5rem] overflow-hidden shadow-[0_30px_100px_rgba(0,0,0,0.95),0_0_40px_rgba(245,158,11,0.2)]"
          >
            ...
            <div className="p-4 sm:p-7 md:p-8 flex items-center justify-between z-20 border-b border-white/10 bg-[#090a18]/80 backdrop-blur-2xl gap-3 sm:gap-4">
              <div className="flex items-center gap-3 sm:gap-4">
                <div className="flex h-9 w-9 sm:h-11 sm:w-11 shrink-0 items-center justify-center rounded-xl sm:rounded-2xl border border-amber-400/30 bg-amber-500/15 shadow-[0_0_20px_rgba(245,158,11,0.3)]">
            ...
            <div className="px-3.5 sm:px-7 py-2.5 sm:py-3 border-b border-white/10 bg-[#060712]/95 backdrop-blur-md flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2.5 sm:gap-3 z-10">
              <div className="flex items-center gap-2.5 sm:gap-3">
                <span className="text-[9px] font-black uppercase tracking-widest text-zinc-500">
                  Live Preview:
                </span>
                <div className="flex items-center gap-2 px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-full bg-white/[0.05] border border-white/10 shadow-inner">
                  <AvatarWithFrame
                    avatarUrl={avatarUrl}
                ...
                {items.map((item) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className={cn(
                        "group/card p-3.5 sm:p-5 rounded-2xl sm:rounded-3xl backdrop-blur-xl border transition-all duration-300 flex flex-col justify-between relative overflow-hidden cursor-pointer",
                        isSelected
                    ...
                    >
                      ...
                      <div className="my-2 flex flex-col items-center justify-center min-h-[110px] sm:min-h-[130px] rounded-xl sm:rounded-2xl bg-black/50 border border-white/10 relative overflow-hidden p-2 shadow-inner">
                        <div className="flex flex-col items-center gap-2 sm:gap-2.5 w-full py-1">
                          {/* Centered Crest Jewel */}
                          <div className="p-2.5 sm:p-3 rounded-xl sm:rounded-2xl bg-black/70 border border-white/15 shadow-xl transition-transform duration-300 group-hover/card:scale-110">
                            <CreatorInsignia insigniaId={item.id} size="xl" showTooltip={false} />
                          </div>

                          {/* Realistic Live Inline Pill */}
                          <div className="flex items-center gap-2 px-2.5 sm:px-3 py-1 rounded-full bg-black/60 border border-white/10 max-w-full">
                      ...
                      <div className="mt-2.5 sm:mt-3 pt-2.5 sm:pt-3 border-t border-white/10">
                        {isSelected ? (
                          <div className="w-full py-2 sm:py-2.5 px-3 rounded-xl bg-gradient-to-r from-amber-500 to-yellow-500 text-black font-black text-xs uppercase tracking-wider flex items-center justify-center gap-1.5 shadow-[0_0_20px_rgba(245,158,11,0.5)]">
                          ...
                          <button
                            ...
                            disabled={isApplying}
                            className="w-full py-2 sm:py-2.5 px-3 rounded-xl bg-white/[0.08] hover:bg-white hover:text-black border border-white/20 text-white font-bold text-xs uppercase tracking-wider transition-all duration-300 flex items-center justify-center gap-1.5 cursor-pointer shadow-sm hover:shadow-[0_0_20px_rgba(255,255,255,0.4)]"
                          >
            ...
            {/* Footer Toolbar */}
            <div className="p-3.5 sm:p-5 border-t border-white/10 bg-[#070814]/95 backdrop-blur-2xl flex flex-col gap-2.5 sm:flex-row sm:items-center sm:justify-between z-20">
              <div className="flex items-center gap-2 text-xs font-semibold text-zinc-400">
                <CheckCircle2 size={15} className="text-emerald-400 shrink-0" />
                <span>Click any unlocked crest to equip it immediately</span>
              </div>
