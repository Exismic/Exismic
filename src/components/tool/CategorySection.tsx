      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-col items-center mb-16 space-y-4">
          <motion.div 
            ...
            className="flex items-center gap-2 px-4 py-1.5 rounded-full bg-accent-purple/10 border border-accent-purple/20 text-accent-purple shadow-[0_0_15px_rgba(124,58,237,0.2)]"
          >
            <LayoutGrid size={16} />
            <span className="text-xs font-black uppercase tracking-[0.2em]">Curated Universe</span>
          </motion.div>
          <h2 className="text-4xl md:text-5xl font-black tracking-tighter text-white text-center">
            Explore <span className="gradient-text">Categories</span>
          </h2>
          <p className="text-zinc-500 max-w-lg text-center font-medium">
            ...
            return (
              ...
              >
                <Link href={`/category/${cat.id}`}>
                  <div className={cn(
                    "relative h-full flex flex-col items-center gap-6 p-8 rounded-[2.5rem] glass-dark border border-white/5 transition-all duration-500 overflow-hidden",
                  ...
                  >
                    ...
                    <div className="relative group/icon">
                      <div className={cn(
                        "w-20 h-20 rounded-3xl bg-white/5 flex items-center justify-center transition-all duration-500",
                    ...
                    <div className="flex flex-col items-center text-center">
                      <h3 className="text-xl font-bold text-white tracking-tight mb-2 group-hover:scale-105 transition-transform">
                        {cat.name}
                      </h3>
                      <p className="text-xs font-medium text-zinc-400 leading-relaxed max-w-[140px] group-hover:text-zinc-200 transition-all uppercase tracking-wider">
                        {cat.description}
                      </p>
                    </div>
