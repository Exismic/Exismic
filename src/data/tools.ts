...
export const TOOLS: Tool[] = [
  ...
  { id: 'image-restorer', name: 'Photo Restorer', description: 'Restore and enhance old, damaged, or blurry photos back to their original clarity using smart AI.', category: 'image', icon: 'Sparkle' as IconName, href: '/tools/image/restorer',
    ...
    seoDescription: "Restore old, damaged, or blurry photos with AI photo restorer. Fix scratches, enhance facial details, and unblur free.",
    seoKeywords: ["ai photo restorer","fix blurry photo","restore old photos","photo enhancer online","Exismic"] },
  ...
  { id: 'face-swap', name: 'Face Swap', description: 'Realistically swap faces in photos with high precision and lighting matching using AI.', category: 'image', icon: 'UserCheck' as IconName, href: '/tools/image/face-swap', indexable: false,
    ...
    seoDescription: "Realistic AI face swap online. Swap faces in photos seamlessly with natural lighting and angle alignment.",
    seoKeywords: ["face swap online","ai face swapper","photo face swap free","realistic face swap","Exismic"] },
  ...
  // Video Tools
  { id: 'video-bg-remover', name: 'AI Video BG Remover', description: 'Accurately remove backgrounds from your videos frame-by-frame without needing a green screen.', category: 'video', icon: 'Film' as IconName, href: '/tools/video/bg-remover',
    ...
    seoDescription: "Remove video background online automatically without green screen. Export transparent WebM or green background.",
    seoKeywords: ["video background remover","remove video bg online","no green screen video background remover","Exismic"] },
  ...
  { id: 'audio-music-gen', name: 'AI Music Generator', description: 'Compose completely original music tracks simply by describing the genre, mood, and instruments.', category: 'audio', icon: 'Music' as IconName, href: '/tools/audio/music-gen', indexable: false,
    ...
    seoDescription: "Generate original royalty-free background music and audio tracks from text prompts using AI music composition models.",
    seoKeywords: ["ai music generator","generate background music","ai track creator","text to music generator","Exismic"] },
  {
    id: 'sfx-generator',
...
/*  {
  ...
  // Productivity Tools
  {
    ...
    seoKeywords: ["discord profile card","discord banner generator","discord card maker","Exismic"]
  },
