...
/*  {
  ...
  { id: 'productivity-passgen', name: 'Password Generator', description: 'Generate cryptographically strong, complex passwords to ensure your online accounts stay secure.', category: 'developer', icon: 'ShieldCheck' as IconName, href: '/tools/productivity/passgen',
  ...
  { id: 'productivity-units', name: 'Unit Converter', description: 'Quickly and accurately convert measurements between a massive variety of different units.', category: 'student', icon: 'Scale' as IconName, href: '/tools/productivity/units',
  ...
  { id: 'productivity-json', name: 'JSON Formatter', description: 'Beautify, validate, and structure your messy JSON data so it is perfectly readable.', category: 'developer', icon: 'Code2' as IconName, href: '/tools/productivity/json',
