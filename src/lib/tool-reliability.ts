...
export const TOOL_RELIABILITY: Record<string, ToolReliability> = {
  ...
  "resume-analyzer": {
    ...
    description: "Exismic extracts text from your resume and matches it against your target job description using custom AI model analysis.",
    requirements: ["Language model credentials"],
    dependencyGroups: [{ label: "Language model provider", env: ["GROQ_API_KEYS", "GROQ_API_KEY"] }],
  },
  "sfx-generator": {
    ...
    description: "Exismic generates high-fidelity sound clips from your text descriptions.",
    requirements: ["ElevenLabs API credentials"],
  ...
  "landing-page-generator": {
    ...
    description: "Exismic queries high-performance AI engines to construct clean, modular, and fully styled Tailwind HTML templates from your prompts.",
  ...
  "youtube-summarizer": {
    ...
    description: "Exismic downloads caption tracks directly from YouTube and uses AI models to transcribe, summarize, and draft content summaries.",
    requirements: ["Groq API credentials"],
    dependencyGroups: [{ label: "Language model provider", env: ["GROQ_API_KEYS", "GROQ_API_KEY"] }],
  },
  "qr-generator": {
