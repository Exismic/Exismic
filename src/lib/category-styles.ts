...
export const CATEGORY_ANIM_STYLES: Record<string, CategoryAnimStyle> = {
  pdf: {
    ...
    cardBorder: "border-2 border-red-500/45 shadow-[inset_0_1px_1px_rgba(255,255,255,0.08),0_12px_35px_rgba(0,0,0,0.6),0_0_25px_rgba(239,68,68,0.2)] hover:border-red-400 hover:shadow-[inset_0_1px_2px_rgba(255,255,255,0.15),0_20px_50px_rgba(0,0,0,0.8),0_0_45px_rgba(239,68,68,0.45)]",
    topBeam: "",
  ...
  image: {
    ...
    cardBorder: "border-2 border-cyan-500/45 shadow-[inset_0_1px_1px_rgba(255,255,255,0.08),0_12px_35px_rgba(0,0,0,0.6),0_0_25px_rgba(6,182,212,0.2)] hover:border-cyan-300 hover:shadow-[inset_0_1px_2px_rgba(255,255,255,0.15),0_20px_50px_rgba(0,0,0,0.8),0_0_45px_rgba(6,182,212,0.45)]",
    topBeam: "",
  ...
  audio: {
    ...
    cardBorder: "border-2 border-pink-500/45 shadow-[inset_0_1px_1px_rgba(255,255,255,0.08),0_12px_35px_rgba(0,0,0,0.6),0_0_25px_rgba(236,72,153,0.2)] hover:border-pink-300 hover:shadow-[inset_0_1px_2px_rgba(255,255,255,0.15),0_20px_50px_rgba(0,0,0,0.8),0_0_45px_rgba(236,72,153,0.45)]",
    topBeam: "",
  ...
  video: {
    ...
    cardBorder: "border-2 border-violet-500/45 shadow-[inset_0_1px_1px_rgba(255,255,255,0.08),0_12px_35px_rgba(0,0,0,0.6),0_0_25px_rgba(139,92,246,0.2)] hover:border-violet-300 hover:shadow-[inset_0_1px_2px_rgba(255,255,255,0.15),0_20px_50px_rgba(0,0,0,0.8),0_0_45px_rgba(139,92,246,0.45)]",
    topBeam: "",
  ...
  productivity: {
    ...
    cardBorder: "border-2 border-emerald-500/45 shadow-[inset_0_1px_1px_rgba(255,255,255,0.08),0_12px_35px_rgba(0,0,0,0.6),0_0_25px_rgba(16,185,129,0.2)] hover:border-emerald-300 hover:shadow-[inset_0_1px_2px_rgba(255,255,255,0.15),0_20px_50px_rgba(0,0,0,0.8),0_0_45px_rgba(16,185,129,0.45)]",
    topBeam: "",
  ...
  developer: {
    ...
    cardBorder: "border-2 border-lime-500/45 shadow-[inset_0_1px_1px_rgba(255,255,255,0.08),0_12px_35px_rgba(0,0,0,0.6),0_0_25px_rgba(163,230,53,0.2)] hover:border-emerald-300 hover:shadow-[inset_0_1px_2px_rgba(255,255,255,0.15),0_20px_50px_rgba(0,0,0,0.8),0_0_45px_rgba(0,255,135,0.45)]",
    topBeam: "",
